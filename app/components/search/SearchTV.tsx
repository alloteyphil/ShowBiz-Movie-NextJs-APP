...
const SearchTV = () => {
  ...
  const handleSearch = () => {
    ...
    router.push(`/search/tv?query=${search}&page=1`);
  };

  return (
    <div className="w-full flex flex-col gap-4 md:gap-6 lg:gap-8 fadeIn">
      <input
        type="text"
        className="
      w-full 
      ...
      placeholder:text-xl md:placeholder:text-2xl lg:placeholder:text-3xl
    ...
    "
      ...
      />
      <p className="text-darkAsh w-full text-center text-xs md:text-sm lg:text-base">
