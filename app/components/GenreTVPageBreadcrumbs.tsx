...
const GenreTVPageBreadcrumbs = async ({ id }: { id: string }) => {
  let genre;
  ...
  try {
    const res = await fetch(
      `https://api.themoviedb.org/3/genre/tv/list?api_key=${process.env.IMDB_API_KEY}&language=en`,
    );
...
export default GenreTVPageBreadcrumbs;
